...
//
EXTERN_C HRESULT VCIAPI
  canMsgSwitchSigSetLoadDB( IN  HANDLE hSigSet,
                            IN  PWCHAR pszFile,
                            IN  PWCHAR pszSigs,
                            IN  UINT16 awDepth[],
                            OUT HANDLE ahSigId[],
...
typedef HRESULT
  (VCIAPI *PF_canMsgSwitchSigSetLoadDB)( IN  HANDLE hSigSet,
                                         IN  PWCHAR pszFile,
                                         IN  PWCHAR pszSigs,
                                         IN  UINT16 awDepth[],
                                         OUT HANDLE ahSigId[],
...
EXTERN_C HRESULT VCIAPI
  canMsgSwitchSigSetSaveDB( IN  HANDLE  hSigSet,
                            IN  PWCHAR  pszFile,
                            IN  HANDLE  ahSigId[],
                            IN  UINT32  dwCount,
                            OUT PUINT32 pdwSave );
...
typedef HRESULT
  (VCIAPI *PF_canMsgSwitchSigSetSaveDB)( IN  HANDLE  hSigSet,
                                         IN  PWCHAR  pszFile,
                                         IN  HANDLE  ahSigId[],
                                         IN  UINT32  dwCount,
                                         OUT PUINT32 pdwSave );
...
EXTERN_C HRESULT VCIAPI
  canMsgSwitchSigSetGetAttr( IN  HANDLE  hSigSet,
                             IN  HANDLE  hSigId,
                             IN  UINT32  dwAttr,
                             OUT PVOID   pvData,
                             IN  UINT32  dwSize,
...
typedef HRESULT
  (VCIAPI *PF_canMsgSwitchSigSetGetAttr)( IN  HANDLE  hSigSet,
                                          IN  HANDLE  hSigId,
                                          IN  UINT32  dwAttr,
                                          OUT PVOID   pvData,
                                          IN  UINT32  dwSize,
...
EXTERN_C HRESULT VCIAPI
  canMsgSwitchSigSetSetAttr( IN HANDLE hSigSet,
                             IN HANDLE hSigId,
                             IN UINT32 dwAttr,
                             IN PVOID  pvData,
                             IN UINT32 dwSize );
...
typedef HRESULT
  (VCIAPI *PF_canMsgSwitchSigSetSetAttr)( IN HANDLE hSigSet,
                                          IN HANDLE hSigId,
                                          IN UINT32 dwAttr,
                                          IN PVOID  pvData,
                                          IN UINT32 dwSize );
