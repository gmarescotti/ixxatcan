...
#define VCI_DEVIF_PCI        0x00000006 // PCI interface
#define VCI_DEVIF_PCIx       0x00000007 // extended PCI interface
#define VCI_DEVIF_PCIe       0x00000008 // PCI express interface

//--- embedded interfaces ------------------------------------------------

#define VCI_DEVIF_GPIO       0x00010000 // General Purpose I/O interface
#define VCI_DEVIF_SPI        0x00010001 // Serial Peripheral Interface
#define VCI_DEVIF_I2C        0x00010002 // inter-integrated circuit (I gradi C)
